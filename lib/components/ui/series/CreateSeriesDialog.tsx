...
export function CreateSeriesDialog({
  ...
  // Pattern reset state khi đóng/mở Modal
  ...
  // Fetch danh sách Thương hiệu cho ô Select
  useEffect(() => {
    if (!open) return;
          ...
          <div className="space-y-3.5 pt-1">
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                {/*
                  - z-50 & bg-white & border: Đảm bảo danh sách nổi hoàn toàn lên trên các phần tử khác.
                  - max-h-60: Giới hạn chiều cao menu thả xuống để tránh chèn hết khung hình.
                */}
                <SelectContent
                  position="popper"
