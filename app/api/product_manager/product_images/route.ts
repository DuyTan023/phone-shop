...
// // GET /api/product_manager/product_images?productId=1&type=general
// export async function GET(req: NextRequest) {
//   try {
//     const { searchParams } = new URL(req.url);
//     const productIdStr = searchParams.get("product_id");
//     const variantIdStr = searchParams.get("variant_id");
//     const type = searchParams.get("type"); // 'general' | 'variant'

//     if (!productIdStr && !variantIdStr) {
//       return NextResponse.json<ApiResponse<null>>(
//         {
//           success: false,
//           message: "Cần truyền productId hoặc variantId để truy vấn",
//         },
//         { status: 400 },
//       );
//     }
...
//       } else {
//         // Mặc định nếu chỉ có productId thì dùng hàm lấy nhóm màu hoặc custom tùy nhu cầu
//         data = await productImageService.getGeneralImages(productId);
//       }
//     }
...
// app/api/product_manager/product_images/route.ts
